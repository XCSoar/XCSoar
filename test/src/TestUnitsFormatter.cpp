...
TestAltitude()
{
  ...
  ok1(StringIsEqual(buffer, "1234 m"));

  FormatAltitude(buffer, Units::ToSysUnit(1234, Unit::FEET), Unit::FEET);
  ok1(StringIsEqual(buffer, "1234 ft"));
...
TestDistance()
{
  ...
  ok1(StringIsEqual(buffer, "123.4 km"));
  ...
  FormatDistance(buffer, Units::ToSysUnit(123.4, Unit::NAUTICAL_MILES),
                 Unit::NAUTICAL_MILES);
  ok1(StringIsEqual(buffer, "123 NM"));
  ...
  ok1(StringIsEqual(buffer, "123.4 NM"));
  ...
  FormatDistance(buffer, Units::ToSysUnit(123.4, Unit::STATUTE_MILES),
                 Unit::STATUTE_MILES);
  ok1(StringIsEqual(buffer, "123 mi"));
  ...
  ok1(StringIsEqual(buffer, "123.4 mi"));
...
TestSmallDistance()
{
  ...
  FormatSmallDistance(buffer, Units::ToSysUnit(123.4, Unit::FEET),
                      Unit::NAUTICAL_MILES);
  ok1(StringIsEqual(buffer, "123 ft"));
  ...
  FormatSmallDistance(buffer, Units::ToSysUnit(123.4, Unit::FEET),
                      Unit::NAUTICAL_MILES, true, 1);
  ok1(StringIsEqual(buffer, "123.4 ft"));
...
TestDistanceSmart()
{
  ...
  // Test Meter
  TestDistanceSmart(0.1234, Unit::METER, Unit::METER, "0.12 m",
                    "0.12");

  TestDistanceSmart(1.234, Unit::METER, Unit::METER, "1.23 m",
                    "1.23");

  TestDistanceSmart(12.34, Unit::METER, Unit::METER, "12.3 m",
                    "12.3");

  TestDistanceSmart(123.4, Unit::METER, Unit::METER, "123 m",
                    "123");

  TestDistanceSmart(1234, Unit::METER, Unit::METER, "1234 m",
                    "1234");

  TestDistanceSmart(12345, Unit::METER, Unit::METER, "12345 m",
                    "12345");

  TestDistanceSmart(123456, Unit::METER, Unit::METER, "123456 m",
                    "123456");

  // Test Kilometer
  TestDistanceSmart(Units::ToSysUnit(0.1234, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::METER, "123 m", "123");

  TestDistanceSmart(Units::ToSysUnit(1.234, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::METER, "1234 m", "1234");

  TestDistanceSmart(Units::ToSysUnit(2.345, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::METER, "2345 m", "2345");

  TestDistanceSmart(Units::ToSysUnit(2.634, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::KILOMETER, "2.63 km",
                    "2.63");

  TestDistanceSmart(Units::ToSysUnit(12.34, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::KILOMETER, "12.3 km",
                    "12.3");

  TestDistanceSmart(Units::ToSysUnit(123.4, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::KILOMETER, "123 km", "123");

  // Test Nautical Miles
  TestDistanceSmart(Units::ToSysUnit(123.4, Unit::FEET),
                    Unit::NAUTICAL_MILES, Unit::FEET, "123 ft", "123");

  TestDistanceSmart(Units::ToSysUnit(1234, Unit::FEET),
                    Unit::NAUTICAL_MILES, Unit::FEET, "1234 ft",
                    "1234");

  TestDistanceSmart(Units::ToSysUnit(2345, Unit::FEET),
                    Unit::NAUTICAL_MILES, Unit::FEET, "2345 ft",
                    "2345");

  TestDistanceSmart(Units::ToSysUnit(0.61, Unit::NAUTICAL_MILES),
                    Unit::NAUTICAL_MILES, Unit::NAUTICAL_MILES, "0.61 NM",
                    "0.61");

  TestDistanceSmart(Units::ToSysUnit(1.234, Unit::NAUTICAL_MILES),
                    Unit::NAUTICAL_MILES, Unit::NAUTICAL_MILES, "1.23 NM",
                    "1.23");

  TestDistanceSmart(Units::ToSysUnit(12.34, Unit::NAUTICAL_MILES),
                    Unit::NAUTICAL_MILES, Unit::NAUTICAL_MILES, "12.3 NM",
                    "12.3");

  TestDistanceSmart(Units::ToSysUnit(123.4, Unit::NAUTICAL_MILES),
                    Unit::NAUTICAL_MILES, Unit::NAUTICAL_MILES, "123 NM",
                    "123");

  // Test Statute Miles
  TestDistanceSmart(Units::ToSysUnit(123.4, Unit::FEET),
                    Unit::STATUTE_MILES, Unit::FEET, "123 ft", "123");

  TestDistanceSmart(Units::ToSysUnit(1234, Unit::FEET),
                    Unit::STATUTE_MILES, Unit::FEET, "1234 ft", "1234");

  TestDistanceSmart(Units::ToSysUnit(2345, Unit::FEET),
                    Unit::STATUTE_MILES, Unit::FEET, "2345 ft", "2345");

  TestDistanceSmart(Units::ToSysUnit(0.71, Unit::STATUTE_MILES),
                    Unit::STATUTE_MILES, Unit::STATUTE_MILES, "0.71 mi",
                    "0.71");

  TestDistanceSmart(Units::ToSysUnit(1.234, Unit::STATUTE_MILES),
                    Unit::STATUTE_MILES, Unit::STATUTE_MILES, "1.23 mi",
                    "1.23");

  TestDistanceSmart(Units::ToSysUnit(12.34, Unit::STATUTE_MILES),
                    Unit::STATUTE_MILES, Unit::STATUTE_MILES, "12.3 mi",
                    "12.3");

  TestDistanceSmart(Units::ToSysUnit(123.4, Unit::STATUTE_MILES),
                    Unit::STATUTE_MILES, Unit::STATUTE_MILES, "123 mi",
                    "123");

  // Test thresholds
  TestDistanceSmart(Units::ToSysUnit(0.9, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::METER, "900 m", "900", 1000);

  TestDistanceSmart(Units::ToSysUnit(1.1, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::KILOMETER, "1.10 km", "1.10", 1000);

  TestDistanceSmart(Units::ToSysUnit(1.1, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::KILOMETER, "1.1 km", "1.1", 1000, 10);

  TestDistanceSmart(Units::ToSysUnit(1.1, Unit::KILOMETER),
                    Unit::KILOMETER, Unit::KILOMETER, "1 km", "1", 1000, 1);
...
TestSpeed()
{
  ...
  FormatSpeed(buffer, Units::ToSysUnit(83.43, Unit::KILOMETER_PER_HOUR),
              Unit::KILOMETER_PER_HOUR, true, true);
  ok1(StringIsEqual(buffer, "83.4 km/h"));

  FormatSpeed(buffer, Units::ToSysUnit(123.43, Unit::KNOTS),
              Unit::KNOTS);
  ok1(StringIsEqual(buffer, "123 kt"));
  ...
  FormatSpeed(buffer,
              ...
              Unit::STATUTE_MILES_PER_HOUR, true, true);
  ok1(StringIsEqual(buffer, "83.4 mph"));
}
...
TestPressure()
{
  ...
  FormatPressure(buffer, AtmosphericPressure::HectoPascal(1013.25),
                 Unit::HECTOPASCAL);
  ok1(StringIsEqual(buffer, "1013 hPa"));

  FormatPressure(buffer, AtmosphericPressure::HectoPascal(1013.25),
                 Unit::HECTOPASCAL, false);
  ok1(StringIsEqual(buffer, "1013"));
