...
2. `xcsoar-checklist.txt` in the XCSoar data directory (typically
   `checklists/xcsoar-checklist.txt`; see [XCSoar data
   directory](/dev/data-directory))
...
name and frequency. A short confirmation appears after a successful tap; invalid
links show a warning.
