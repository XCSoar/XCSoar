...
def main() -> int:
  ...
  original_map = {entry_key(e): e for e in original_po if e.msgid}
  normalized_map = {entry_key(e): e for e in normalized_po if e.msgid}
  ...
  original_path.write_text("".join(original_lines), encoding="utf-8")
  return 0
