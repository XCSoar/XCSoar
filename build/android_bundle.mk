...
$(ANDROID_OUTPUT_DIR)/resources.apk: $(PNG_FILES) $(SOUND_FILES) $(ANDROID_XML_RES_COPIES) $(MANIFEST) | $(GEN_DIR)/dirstamp $(COMPILED_RES_DIR)/dirstamp
	@$(NQ)echo "  AAPT2"
	$(Q)$(AAPT2) compile \
		-o $(COMPILED_RES_DIR) \
		--dir $(RES_DIR)
	$(Q)$(AAPT2) link --auto-add-overlay \
...
# R.java is generated by aapt2, when resources.apk is generated
