...
ifneq ($(TARGET_IS_DARWIN),y)
  ...
  CLANG_MAIN_VERSION := $(shell expr `$(LLVM_PREFIX)clang++$(LLVM_SUFFIX)$(EXE) -dumpversion | cut -f1 -d.`)
  CLANG_14_OR_MORE := $(shell expr $(CLANG_MAIN_VERSION) \>= 14)

  ifeq ($(CLANG_14_OR_MORE), 1)
