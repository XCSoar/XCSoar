...
$(ANDROID_OUTPUT_DIR)/resources.apk: $(PNG_FILES) $(SOUND_FILES) $(ANDROID_XML_RES_COPIES) | $(GEN_DIR)/dirstamp
	@$(NQ)echo "  AAPT"
...
# build libxcsoar.so
$$(TARGET_OUTPUT_DIR)/$(2)/$$(XCSOAR_ABI)/bin/lib$(1).so: $(NATIVE_HEADERS) $(HOST_OUTPUT_DIR)/tools/GenerateSineTables$(HOST_EXEEXT) FORCE
