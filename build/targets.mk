...
ifeq ($(TARGET),ANDROID)
  ...
  ifeq ($(HOST_IS_DARWIN),y)
    ANDROID_TOOLCHAIN = $(ANDROID_NDK)/toolchains/$(ANDROID_TOOLCHAIN_NAME)/prebuilt/darwin-x86
  else ifeq ($(WINHOST),y)
    ANDROID_TOOLCHAIN = $(ANDROID_NDK)/toolchains/$(ANDROID_TOOLCHAIN_NAME)/prebuilt/windows
  else
    ANDROID_TOOLCHAIN = $(ANDROID_NDK)/toolchains/$(ANDROID_TOOLCHAIN_NAME)/prebuilt/linux-x86
  endif
