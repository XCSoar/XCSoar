...
class Libs:
    def __init__(self,toolchain):
        ...
        self.libstdcxx_musl_headers = LibstdcxxMuslHeadersProject(
            toolchain,
            ...
            [
                ...
                '--disable-multilib',
                '--disable-bootstrap',
                '--build=' + toolchain.toolchain_arch,
                '--target=' + toolchain.actual_arch
            ],
            config_script='libstdc++-v3/configure',
            use_actual_arch=True,
        )
        
        self.openssl = OpenSSLProject(
            toolchain,
