...
RUN_DIALOG_LDADD = \
	$(RESOURCE_BINARY) \
	$(FAKE_LIBS)
RUN_DIALOG_DEPENDS = IO FORM DATA_FIELD SCREEN EVENT OS THREAD MATH ZZIP UTIL TIME
...
RUN_TEXT_ENTRY_DEPENDS = FORM DATA_FIELD SCREEN EVENT IO OS THREAD MATH UTIL ZLIB TIME
...
RUN_NUMBER_ENTRY_DEPENDS = FORM DATA_FIELD SCREEN EVENT IO OS THREAD MATH UTIL ZLIB TIME
...
RUN_TIME_ENTRY_DEPENDS = FORM DATA_FIELD SCREEN EVENT IO OS THREAD MATH UTIL ZLIB TIME
...
RUN_ANALYSIS_LDADD = \
	$(RESOURCE_BINARY)
RUN_ANALYSIS_DEPENDS = DRIVER PROFILE FORM SCREEN EVENT IO DATA_FIELD OS THREAD CONTEST TASK ROUTE GLIDE WAYPOINT ROUTE AIRSPACE JASPER ZZIP UTIL GEO MATH TIME
...
RUN_AIRSPACE_WARNING_DIALOG_LDADD = \
	$(FAKE_LIBS) \
	$(RESOURCE_BINARY)
RUN_AIRSPACE_WARNING_DIALOG_DEPENDS = FORM DATA_FIELD SCREEN EVENT IO OS THREAD AIRSPACE ZZIP UTIL GEO MATH TIME
...
RUN_TASK_EDITOR_DIALOG_LDADD = \
	$(FAKE_LIBS) \
	$(RESOURCE_BINARY)
RUN_TASK_EDITOR_DIALOG_DEPENDS = FORM DATA_FIELD SCREEN EVENT IO OS THREAD ZZIP UTIL GEO
...
TEST_NOTIFY_DEPENDS = SCREEN EVENT MATH UTIL OS THREAD
