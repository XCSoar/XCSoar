...
RUN_DIALOG_LDADD = \
	$(RESOURCE_BINARY) \
	$(FAKE_LIBS)
RUN_DIALOG_DEPENDS = IO DATA_FIELD FORM SCREEN EVENT OS THREAD MATH ZZIP UTIL TIME
...
RUN_JOB_DIALOG_DEPENDS = SCREEN EVENT OS THREAD MATH UTIL
...
RUN_AIRSPACE_WARNING_DIALOG_LDADD = \
	$(FAKE_LIBS) \
	$(RESOURCE_BINARY)
RUN_AIRSPACE_WARNING_DIALOG_DEPENDS = DATA_FIELD FORM SCREEN EVENT IO OS THREAD AIRSPACE ZZIP UTIL GEO MATH TIME
...
RUN_TASK_EDITOR_DIALOG_LDADD = \
	$(FAKE_LIBS) \
	$(RESOURCE_BINARY)
RUN_TASK_EDITOR_DIALOG_DEPENDS = DATA_FIELD FORM SCREEN EVENT IO OS THREAD ZZIP UTIL GEO
