...
/**
 * Maximum number of control points in a materialized RASP color ramp.
 * Current RaspStylesData maps use at most 26 points; keep headroom for
 * future maps.
 */
static constexpr unsigned MAX_COLOR_MAP_POINTS = 32;
...
struct MaterializedColorRamp {
  StaticArray<ColorRampEntry, MAX_COLOR_MAP_POINTS> entries;
  StaticArray<ColorRampEntryAlpha, MAX_COLOR_MAP_POINTS> entries_alpha;
  bool has_alpha;
  uint32_t hash;

  /**
   * Build a transient ColorRamp struct pointing into our arrays.
