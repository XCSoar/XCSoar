...
static constexpr unsigned FORECAST_HOURS_PER_DAY = 24;
...
/**
 * Resolve the next lower EDL isobar for the current aircraft altitude:
 * the lowest supported pressure level above the aircraft.
 */
[[gnu::pure]]
unsigned
