...
void
SkysightRequest::FileHandler::DataReceived(const void *data, size_t length)
{
...
void
SkysightRequest::FileHandler::ResponseReceived(int64_t content_length)
{
}
...
void
SkysightRequest::BufferHandler::ResponseReceived(int64_t content_length)
{
}

void
SkysightRequest::BufferHandler::DataReceived(const void *data, size_t length)
{
