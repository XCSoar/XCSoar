...
static constexpr MetaData meta_data[] = {
  ...
  // e_NearestAirspaceVertical
  {
    ...
    N_("Near AS V"),
    N_("Vertical distance to the nearest airspace.  A positive value means the airspace is above you, and negative means the airspace is below you."),
  ...
  // Radio
  {
    ...
    N_("Act Freq"),
    N_("Currently active Radio Frequency"),
...

  {
    ...
    N_("Stby Freq"),
    N_("Currently standby Radio Frequency"),
  ...
  // e_AAT_dT_or_ETA
  {
    ...
    N_("AATdeltaOrETA"),
    N_("AAT delta time and estimated time of arrival in case of AAT task, and estimated time of arrival in case of racing task"),
