...
const Brush& TrafficLook::GetBasicTrafficBrush(const TrafficClimbAltIndicators &indicators) const
{
...
const Brush& TrafficLook::GetColourfulTrafficBrush(const TrafficClimbAltIndicators &indicators) const
{
