...
public:
  ...
  void Prepare([[maybe_unused]] ContainerWindow &parent,
    ...
    AddButton(_("Import data"), [](){ ShowMessageBox(_("Import data is not available."), _("Import data"), MB_OK); });
    AddButton(_("Backup manager"), [](){ ShowMessageBox(_("Backup manager is not available."), _("Backup manager"), MB_OK); });
  }
};
...
ShowDataManagementDialog()
{
  ...
  TWidgetDialog<DataManagementWidget> dlg(WidgetDialog::Full{}, UIGlobals::GetMainWindow(),
