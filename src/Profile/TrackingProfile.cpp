...
{
  map.GetEnum(ProfileKeys::LiveTrack24TrackingVehicleType, settings.livetrack24.vehicleType);
  map.Get(ProfileKeys::LiveTrack24TrackingVehicleName, settings.livetrack24.vehicle_name);
