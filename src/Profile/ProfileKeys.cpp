...
const TCHAR szProfileAltitudeUnitsValue[] = _T("AltitudeUnit");
const TCHAR szProfileTemperatureUnitsValue[] = _T("TemperatureUnit");
...
const TCHAR szProfileDistanceUnitsValue[] = _T("DistanceUnit");
...
const TCHAR szProfileLiftUnitsValue[] = _T("LiftUnit");
...
const TCHAR szProfileSpeedUnitsValue[] = _T("SpeedUnit");
const TCHAR szProfileTaskSpeedUnitsValue[] = _T("TaskSpeedUnit");
...
const TCHAR szProfileSoundAudioVario[] = _T("AudioVario2");
...
const TCHAR szProfileEnableNMEALogger[] = _T("EnableNMEALogger");
...
const TCHAR ProfileTrackingInterval[] = _T("TrackingInterval");
const TCHAR ProfileTrackingVehicleType[] = _T("TrackingVehicleType");
const TCHAR ProfileSkyLinesTrackingEnabled[] = _T("SkyLinesTrackingEnabled");
const TCHAR ProfileSkyLinesTrackingKey[] = _T("SkyLinesTrackingKey");
const TCHAR ProfileLiveTrack24Enabled[] = _T("LiveTrack24Enabled");
