...
constexpr std::string_view HideQuickGuideDialogOnStartup = "HideQuickGuideDialogOnStartup";
constexpr std::string_view DisclaimerAcknowledgedVersion = "DisclaimerAcknowledgedVersion";
constexpr std::string_view LastSeenNewsVersion = "LastSeenNewsVersion";
}
