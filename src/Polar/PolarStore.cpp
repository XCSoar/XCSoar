...
static constexpr Item internal_polars[] = {
  ...
  { _T("LS-5"), 461, 120, 75, -0.45, 135, -1.0, 172.5, -1.9, 13.9, 0.0, 0, 361 },
  ...
  { _T("Std Austria S"), 297, 0, 70.0, -0.70, 118.0, -1.0, 145.0, -1.5, 13.5 , 0.0, 90, 205}, // From Schempp sales sheet, potentially to good
