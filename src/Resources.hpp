...
MAKE_RESOURCE(IDB_VRP, 370);
MAKE_RESOURCE(IDB_VRP_HD, 5370);
MAKE_RESOURCE(IDB_VOR, 371);
MAKE_RESOURCE(IDB_VOR_HD, 5371);
MAKE_RESOURCE(IDB_NDB, 372);
MAKE_RESOURCE(IDB_NDB_HD, 5372);
