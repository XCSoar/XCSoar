...
/**
 * Convert a NOTAM to XCSoar airspace format and add it to the airspace database
 * 
 ...
 */
unsigned
ConvertNOTAMsToAirspaces(const std::vector<NOTAM> &notams, Airspaces &airspaces);
