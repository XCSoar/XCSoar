...
#include "org_xcsoarte_NativeInputListener.h"
...
Java_org_xcsoarte_NativeInputListener_dataReceived(JNIEnv *env, jobject obj,
...
{
  cls.Find(env, "org/xcsoarte/NativeInputListener");
