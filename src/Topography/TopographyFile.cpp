...
TopographyFile::TopographyFile(zzip_dir *_dir, const char *filename,
                               ...
                               int _label_field,
                               ResourceId _icon, ResourceId _mdpi_icon,
                               ResourceId _xhdpi_icon,
                               ResourceId _xxhdpi_icon,
                               unsigned _pen_width)
  :dir(_dir),
   file(dir, filename),
   label_field(_label_field),
   icon(_icon), mdpi_icon(_mdpi_icon), xhdpi_icon(_xhdpi_icon),
   xxhdpi_icon(_xxhdpi_icon),
