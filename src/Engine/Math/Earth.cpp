                ...
                const GeoPoint loc3, GeoPoint *loc4)
{
  ...
  if (loc4) {
    ...
    *loc4 = IntermediatePoint(loc1, loc2, ATD, dist_AB.Radians());
  }
                      ...
                      fixed Distance)
{
  ...
  Bearing.SinCos(sinBearing, cosBearing);

  fixed sinLatitude, cosLatitude;
  loc.latitude.SinCos(sinLatitude, cosLatitude);
