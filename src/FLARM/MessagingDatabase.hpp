...
public:
  /**
   * Finds a MessagingRecord object based on the given FLARM id
   * @param id FLARM id
   * @return Mutable MessagingRecord pointer or nullptr
   */
  MessagingRecord *FindRecordById(FlarmId id) noexcept;

  /**
   * Finds a MessagingRecord object snapshot based on the given FLARM id (thread-safe)
   * @param id FLARM id
