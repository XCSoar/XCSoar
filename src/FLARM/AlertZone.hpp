...
struct FlarmAlertZone {
  ...
  static constexpr const char *GetZoneTypeString(uint8_t type) noexcept {
    switch (type) {
    case 0x41:
      return "Skydiver drop zone";
    case 0x42:
      return "Aerodrome traffic zone";
    case 0x43:
      return "Military firing area";
    case 0x44:
      return "Kite flying zone";
    case 0x45:
      return "Winch launching area";
    case 0x46:
      return "RC flying area";
    case 0x47:
      return "UAS flying area";
    case 0x48:
      return "Aerobatic box";
    case 0x7E:
      return "Danger area";
    case 0x7F:
