...
mode_id = InputEvents::mode2int(TEXT("default"));
KeyEvent[mode_id][VK_APP1] = event_id;

event_id = InputEvents::makeEvent(&eventMarkLocation, TEXT(""));
mode_id = InputEvents::mode2int(TEXT("default"));
KeyEvent[mode_id][VK_APP2] = event_id;

event_id = InputEvents::makeEvent(&eventSelectInfoBox, TEXT(""));
mode_id = InputEvents::mode2int(TEXT("default"));
KeyEvent[mode_id][VK_APP3] = event_id;

event_id = InputEvents::makeEvent(&eventMode, TEXT("display1"));
mode_id = InputEvents::mode2int(TEXT("default"));
KeyEvent[mode_id][VK_APP4] = event_id;

event_id = InputEvents::makeEvent(&eventScaleZoom, TEXT("-"));
mode_id = InputEvents::mode2int(TEXT("default"));
KeyEvent[mode_id][VK_DOWN] = event_id;

event_id = InputEvents::makeEvent(&eventScaleZoom, TEXT("+"));
mode_id = InputEvents::mode2int(TEXT("default"));
KeyEvent[mode_id][VK_UP] = event_id;

event_id = InputEvents::makeEvent(&eventSelectInfoBox, TEXT("previous"));
mode_id = InputEvents::mode2int(TEXT("infobox"));
KeyEvent[mode_id][VK_APP1] = event_id;
...
mode_id = InputEvents::mode2int(TEXT("display2"));
