...
WinPilotPolarInternal WinPilotPolars[] =
{
  ...
  { _T("1-36 Sprite"), 322, 0, 75.98, -0.68, 132.96, -2, 170.95, -4.1, 13.10},
  { _T("604"), 570, 100, 112.97, 0.72, 150.64, -1.42, 207.13, -4.1, 16.26},
  { _T("ASH-25M 2"), 750, 121, 130.01, -0.78, 169.96, -1.4, 219.94, -2.6, 16.31},
  { _T("ASH-25M 1"), 660, 121, 121.3, -0.73, 159.35, -1.31, 206.22, -2.4, 16.31},
  ...
  { _T("AstirCS"), 330, 90, 75.0, -0.7, 93.0, -0.74, 185.00, -3.1, 12.40},
  ...
  { _T("ASW-27 Wnglts"), 357, 165, 108.8, -0.64, 156.4, -1.18, 211.13, -2.5, 9.0},
  { _T("Std Cirrus"), 337, 80, 93.23, -0.74, 149.17, -1.71, 205.1, -4.2, 10.04},
  { _T("Cobra (SZD-36)"), 350, 30, 70.8, -0.60, 94.5, -0.69, 148.1, -1.83, 11.6},
  ...
  { _T("DG-800 18m Wnglts"), 472, 120, 106, -0.62, 171.75, -1.47, 214.83, -2.4, 11.81},
  { _T("Discus A"), 350, 182, 103.77, -0.72, 155.65, -1.55, 190.24, -3.1, 10.58},
  ...
  { _T("Grob G-103 Twin II (PAS)"), 580, 0, 99, -0.8, 175.01, -1.95, 225.02, -3.8, 17.52},
  { _T("Grob G-103 Twin II (PIL)"), 494, 0, 90.75, -0.74, 161.42, -1.8, 207.54, -3.5, 17.52},
  ...
  { _T("Jantar 2 (SZD-42A)"), 482, 191, 109.5, -0.66, 157.14, -1.47, 196.42, -2.7, 14.27},
  { _T("Janus B (18.2m PAS)"), 603, 170, 115.5, -0.76, 171.79, -1.98, 209.96, -4.0, 17.4},
  { _T("Janus B (18.2m PIL)"), 508, 170, 105.7, -0.7, 157.65, -1.82, 192.68, -3.6, 17.4},
  ...
  { _T("LS7wl"), 350, 150, 103.77, -0.73, 155.65, -1.47, 180.00, -2.66, 9.80},
  ...
  { _T("SZD-55-1"), 350, 200, 100.0, -0.66, 120, -0.86, 150, -1.4, 9.60},
  ...
  { _T("Speed Astir"),351, 90, 90, -0.63, 105, -0.72, 157, -2.00, 11.5}, // BestLD40@105
  { _T("LS-6-18W"), 330, 140, 90, -0.51, 100, -0.57, 183, -2.00, 11.4}, // BestLD48@100
  { _T("LS-8-15"), 325, 185, 70, -0.51, 115, -0.85, 173, -2.00, 10.5}, // BestLD42.5@97kph
  { _T("LS-8-18"), 325, 185, 80, -0.51, 94, -0.56, 173, -2.00, 11.4}, // BestLD48
  { _T("ASH-26E"), 435, 90, 90, -0.51, 96, -0.53, 185, -2.00, 11.7}, // BestLD50@96kph
  { _T("ASG29-18"), 355, 225, 85, -0.47, 90, -0.48, 185, -2.00, 10.5}, // BestLD52@90kph
  { _T("ASW28-18"), 345, 190, 65, -0.47, 107, -0.67, 165, -2.00, 10.5}, // BestLD48@90kph
  { _T("LS-6-15"), 327, 160, 90, -0.6, 100, -0.658, 183, -1.965, 10.53}, // BestLD42@?
  { _T("ASG29E-18"), 400, 200, 90, -0.499, 95.5, -0.510, 196.4, -2.12, 10.5}, // BestLD52@90kph
  { _T("Ventus CM (17.6m)"), 430, 0, 100.17, -0.6, 159.7, -1.32, 210.54, -2.5, 10.14},
  ...
  { _T("Lak17A-18"), 298, 180, 115, -0.680, 158, -1.379, 200, -2.975, 9.80},
  { _T("Lak17A-15"), 285, 180, 95, -0.574, 148, -1.310, 200, -2.885, 9.06},
  { _T("ASG29-15"), 362, 165, 108.8, -0.635, 156.4, -1.182, 211.13, -2.540, 9.20},
  { _T("DG-300"), 310, 190, 95.0, -0.66, 140.0, -1.28, 160.0, -1.70, 10.27},
  { _T("Para EN C/DHV2"), 110, 4.19, 33.0, -1.0, 39.0, -1.2, 56.0, -2.30, 0},

  // { _T("LS-6 (15m)"), 325, 140, 90, -0.59, 100, -0.66, 212.72, -3.4, 0}, // BestLD42
  // { _T("H304cz"), 310, 115, 115.03, -0.86, 174.04, -1.76, 212.72, -3.4, 0}, // BestLD42@102
  // { _T("ASG29-15"), 340, 170, 115.03, -0.86, 174.04, -1.76, 212.72, -3.4, 0}, // BestLD50@100kph
  // { _T("ASW28-15"), 333, 190, 115.03, -0.86, 174.04, -1.76, 212.72, -3.4, 0}, // BestLD45@90kph
