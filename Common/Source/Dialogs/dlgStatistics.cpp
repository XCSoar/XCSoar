...
void Statistics::RenderBarograph(Canvas &canvas, const RECT rc)
{
  ...
  DrawFilledLineGraph(canvas, rc, &GlideComputer::flightstats.Altitude_Terrain,
                GROUND_COLOUR);
  ...
  DrawLineGraph(canvas, rc, &GlideComputer::flightstats.Altitude,
                STYLE_MEDIUMBLACK);

  DrawTrend(canvas, rc, &GlideComputer::flightstats.Altitude_Base, STYLE_BLUETHIN);
...
void Statistics::RenderSpeed(Canvas &canvas, const RECT rc)
{
  ...
  DrawLineGraph(canvas, rc, &GlideComputer::flightstats.Task_Speed,
                STYLE_MEDIUMBLACK);

  DrawTrend(canvas, rc, &GlideComputer::flightstats.Task_Speed, STYLE_BLUETHIN);
