...
\begin{itemize}
\item
From the task manager, menu \bmenug{Nav 1}\blink\bmenug{Task} \todonum{descr. tabular "Turn Points"}
and highligh a waypoint, then tap the highlighted waypoint again to display the 
Task point dialogue, then press the \bmenug{Details} \InfoBox.
...
\item
From the menu \bmenug{Nav 1}\blink\bmenug{Alternates} to show the
details of the landables nearest to the aircraft.

\item
From the waypoint selector, menu \bmenug{Nav 1}\blink\bmenug{Waypoint
...
This may be accessed several ways:
\begin{itemize}
\item  From the menu \bmenug{Nav 1}\blink\bmenug{Waypoint List}
\item  From the task editor, menu \bmenug{Nav 1}\blink\bmenug{Task} 
...
\begin{quote}
\bmenug{Nav 1}\blink\bmenug{Task}
\end{quote} 
...
\item From the menu 
\begin{quote}
\bmenug{Nav}\blink\bmenug{Task}
\end{quote}
\item From the analysis dialogue, menu \bmenug{Info}\blink\bmenug{Analysis} and select
...
The menu items \bmenug{Nav}\blink\bmenug{Previous turnpoint} and
\bmenug{Nav}\blink\bmenug{Next turnpoint} have dynamic labels that
indicate the action that will be performed upon selecting the item.

For task points requiring arming, \bmenug{Nav}\blink\bmenug{Next
  turnpoint} becomes \bmenug{Arm turn} if the turn is not armed; if it
is armed, then it becomes \bmenug{Next Turnpoint} allowing manual
advance.   \bmenug{Nav}\blink\bmenug{Previous
  turnpoint} becomes \bmenug{Disarm turn} if the turn is armed; if it
is not armed, then it becomes \bmenug{Previous Turnpoint} allowing manual
...
\begin{itemize}
\item Pressing \bmenug{Nav 2}\blink\bmenug{Task Abort}
\item Choosing an alternate from the list under  \gesture{Down - Left}
 \bmenug{Nav 1}\blink\bmenug{Alternates}
