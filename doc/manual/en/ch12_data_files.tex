...
The following is the list of supported airspace types: Class A-G, Prohibited, Danger Areas,
Restricted, Task Area, CTR, No Gliders, Wave, Transponder Mandatory, and Other.  All other airspace
...
\item Optional the wing area in m$^2$ to allow the wing load computation. 
\end{itemize}
...
the FLARM identifications distributed by the FlarmNet community.
