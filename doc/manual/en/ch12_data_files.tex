...
The text may also specifiy images for airfields.  To show an image directly
in XCSoar use \verb|image=| followed by the file name.  Be sure to avoid
any additional whitespaces around the equal sign or in front of the
keyword. Which files are supported depends on your operating system.
Android supports JPEG files, others mostly only BMP files.
