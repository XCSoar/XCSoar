\input{XCFlashIIconf.tex}%configuration and definition of buttons
...
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Site Files}\blink\bmw{Site files}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\konf{2}{File}{Manager}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Look}\blink\bmw{Language, Input}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\konf{2}{System}{}\blink\bmw{Plane}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\konf{2}{Devices}{}\blink\bmw{edit}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Setup}\blink\bmw{Logger}\\\end{flushleft}

\subsection*{\textcolor{blue}{Time settings}}
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Setup}\blink\bmw{Time}\\\end{flushleft}

\subsection*{\textcolor{blue}{Moving the (Moving) Map manually}}
Time to engage the map.  Navigate through by entering the pan mode.
\begin{flushleft}\hspace*{1cm}\ansi{1}{Pan}{On}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\konf{2}{Replay}{}\blink\bmw{File\dots Start}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Look}\blink\bmw{Screen Layout}\\\end{flushleft}
...
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Look}\blink\bmw{InfoBox Sets}\\\end{flushleft}
...
\subsection*{\textcolor{blue}{Setup Polar}}
Invoke either
\begin{flushleft}\hspace*{1cm}\sk\blink\bmw{Plane}\\\end{flushleft}
or
...
\begin{flushleft}\hspace*{1cm}\konf{1}{Flight}{}\blink\bmw{Wing loading / Bugs / QNH / Max temp}\\\end{flushleft}

\subsection*{\textcolor{blue}{Setup Wind}}
\begin{flushleft}\hspace*{1cm}\konf{1}{Wind}{}\blink\bmw{Auto wind\dots / Speed / Direction}\\\end{flushleft}
...
Creating a new task:
\begin{flushleft}\hspace*{1cm}\nav{1}{Task}{}\blink\bmw{Manage}\blink\bmw{New Task}\\\end{flushleft}
\begin{compactitem}
