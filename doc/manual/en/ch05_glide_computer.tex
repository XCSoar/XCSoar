...
\section{Flight modes} \label{cha:flightmodes}
...
\emph{screen pages}, easily turned by a swipe gesture, pushing a button, 
or, as you have read recently, by XCSoar's flight mode. Further details 
are given in section \ref{sec:infoboxandpages} "Infoboxes and screen 
pages".\config{screenpages}
