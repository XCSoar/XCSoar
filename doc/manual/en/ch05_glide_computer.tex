...
A temperature entered by hand takes precedence and is not overwritten
for the rest of that day.  The following day the forecast is about a
different sky and the lookup resumes.  Where there is no network the
attempt is abandoned after a few seconds and the field simply keeps
its value; nothing is reported, because the lookup was not asked for.
