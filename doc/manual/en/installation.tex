...
\begin{itemize}
\item a specialized GPS receiver gains much better reception providing much better data for measures and calclulations
...
\item some varios allow synchronising the MacCready setting with
  XCSoar
\item flarm (and even ADS-B input) provide informations and stati of others around you - and gives you collision detection
\end{itemize}
