...
\item Try to maintain consistent use of colours in all uses of that function, 
 such as dialog graphics as well as map overlays and infoboxes.
...
\begin{itemize}
\item The Close and Cancel buttons will never appear in the same dialog and 
...
\item Exceptions to all the dialog concepts above are encouraged, but should be 
