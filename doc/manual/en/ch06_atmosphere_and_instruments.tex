...
find the ceiling.  The dry adiabat starts at the elevation of the
ground where the sounding began, taken from the terrain file at the
first measurement after take-off, or from the take-off altitude
without one.  If the atmosphere is stable, no ceiling is found and the
