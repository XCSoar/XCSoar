...
Select a \verb|xcsoar-rasp.dat| file via menu
\menulabelr{\bmenug{Info}\blink\bmenug{Weather}}
\bmenuw{RASP}.  Page configuration (Section~\ref{conf:screenpages})
determines where RASP is shown: set \emph{Map overlay} to \emph{RASP},
...
follows the current local time in 15-minute steps.  Turn it off to select a
