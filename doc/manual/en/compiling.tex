...
\item \href{http://developer.android.com/sdk/ndk/}{Android NDK r11b}
...
\verb|~/opt/android-ndk-r11b|.  You can use the options
...
\begin{verbatim*}
make TARGET=KOBO TCSUFFIX=-5 libs
\end{verbatim*}
