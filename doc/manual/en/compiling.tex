...
\item OpenGL (Mesa)
\item \href{https://glm.g-truc.net}{OpenGL Mathematics (GLM)} 
\item \href{https://savannah.nongnu.org/projects/quilt/}{Quilt} 
...
sudo apt-get install make g++ \
  ...
  librsvg2-bin xsltproc \
  imagemagick gettext \
  mesa-common-dev libgl1-mesa-dev libegl1-mesa-dev glm \
  fonts-dejavu \
  quilt
\end{verbatim*}
