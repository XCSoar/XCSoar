...
\item \href{http://developer.android.com/sdk/ndk/}{Android NDK r12b}
...
\verb|~/opt/android-ndk-r12b|.  You can use the options
...
\href{http://openlinux.amlogic.com:8000/download/ARM/gnutools/arm-2010q1-202-arm-none-linux-gnueabi-i686-pc-linux-gnu.tar.bz2}{gcc
  4.4 cross compiler}, for example in \texttt{/opt}. For the Kobo Glo HD,
install a
...
\texttt{uImage.otg}, \texttt{uImage.kobo}, \texttt{uImage.glohd.otg} and
\texttt{uImage.glohd} to \texttt{/opt/kobo/kernel}.
