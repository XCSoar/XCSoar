...
\item \href{http://developer.android.com/sdk/ndk/}{Android NDK r10b (requires both 32bit and 64bit versions installed)}
...
\verb|~/opt/android-ndk-r10b|.  You can use the options
