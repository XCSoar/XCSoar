...
\item \href{http://developer.android.com/sdk/ndk/}{Android NDK r22b}
...
\verb|~/opt/android-ndk-r22b|.  You can use the options
...
brew install automake autoconf libtool \
  imagemagick ffmpeg librsvg quilt pkg-config
\end{verbatim*}
...
\subsection{Compiling on the Raspberry Pi 4}
...
\subsection{Compiling for the Raspberry Pi 1-3}
...
An ARM toolchain is bootstrapped during the build automatically.  You
