...
\item[Auto logger*]  Enables the automatic starting and stopping of the logger
  on takeoff and landing respectively. With a configured polar, takeoff
  detection uses half its minimum speed. Without a configured or received
  polar, sustained movement and height gain can also indicate a slow launch.
  Configure the correct polar for your aircraft before flight.
