...
\begin{center}
\includegraphics[angle=0,width=0.8\linewidth,keepaspectratio='true']{figures/config-menu.png}
\end{center}
...
from the map file. However, if a map file is used, the useer can still specify the other
