...
\item[Port]  This setting maps an existing interface (port) of your 
  ...
  A pulse oximeter that advertises the standard Pulse Oximeter
  service is also a {\it BLE sensor}.  Saturation is shown in the
  Blood Oxygen InfoBox and on the Devices list.  Bands that hide
  SpO2 behind a private service are not read.
