...
\item[Label visibility*]  Determines whether each airspace shows a
  label with its ceiling and base. \\
  {\bf None}: No labels are displayed. \\
  {\bf All}: Labels are displayed on the airspaces shown on the map.
