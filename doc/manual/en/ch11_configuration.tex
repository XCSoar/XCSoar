...
\item[Port]  This setting maps an existing interface (port) of your 
  ...
  The Devices list shows {\it Heart Rate}, {\it Pressure},
  {\it Temperature}, and {\it Relative humidity} among the other
  sensor flags, and {\it Battery=N\%} when remaining charge is
  known, including BLE sensors that expose the standard heart-rate,
