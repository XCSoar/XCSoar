...
\item[\bmenu{Setup}]
  Allows you to change the behaviour of the setting related to the InfoBox (for example, changing from Auto to Manual MacCready setting mode); or to change the InfoBox itself by pressing \bmenu{Switch InfoBox}, then choosing from a list of all available InfoBoxes.
