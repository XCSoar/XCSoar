...
device.  Cancel is the default choice.  After choosing an action, XCSoar saves
its state and closes its devices before asking the operating system to perform
the action.  Other platforms continue to show only the normal confirmation for
quitting XCSoar.
