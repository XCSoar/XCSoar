...
\includegraphics[angle=0,width=0.75cm,keepaspectratio='true']{icons/gps_acquiring.png} & \includegraphics[angle=0,width=0.75cm,keepaspectratio='true']{icons/gps_disconnected.png}\\
(a) & (b)
\end{tabular}
