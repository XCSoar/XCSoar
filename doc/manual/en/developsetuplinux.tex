...
\xc requires a special version of mingw32 \texttt{cegcc} compiler which was patched to enable compilation of the source. Download at: \href{http://max.kellermann.name/projects/cegcc/}{http://max.kellermann.name/projects/cegcc/}. We are using \texttt{mingw32ce-mk-2020-03-23-amd64.tar.xz}.

The compiler is installed locally in the user directory:

\begin{verbatim}
cd ~/opt/
unxz mingw32ce-mk-2020-03-23-i386.tar.xz
tar xvf mingw32ce-mk-2020-03-23-i386.tar
ln -s  mingw32ce-mk-2020-03-23-i386 mingw32ce
\end{verbatim}
...
repository/android-ndk-r15c-linux-x86_64.zip"
