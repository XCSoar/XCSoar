...
\ibig{Altitude GPS}{Alt GPS}{This is the height above mean sea level reported by the
...
is not available.}
\ibi{Altitude AGL}{Alt AGL}{This is the navigation altitude minus the terrain height
...
\ibi{QFE GPS}{Auto QFE}{Automatic QFE. This altitude value is constantly reset to 
...
down keys. Bottom line shows QNH altitude. Changing QFE does not affect QNH altitude.\footnotemark[1]}
...
\ibi{Thermal average over all}{TAll Avg}{Time-average climb rate in all thermals.}
