...
Each airspace can show an altitude label with its ceiling and base.
When labels would overlap or leave the map, XCSoar tries nearby
positions around the airspace and keeps the last successful slot so
the labels stay steady while the map pans.
