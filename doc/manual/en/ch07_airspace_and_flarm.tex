...
Each airspace can show a small label with its ceiling and base
(Map Display / Airspace, Label visibility).  If one label would cover
another, or sit off the map, it is moved so the figures stay readable.
