...
\begin{itemize}
\item From the main menu \bmenu{Config ..}\blink\bmenu{Settings
Airspace}.
...
\bmenu{Info ...}\blink\bmenu{FLARM Radar}.
...
\bmenu{Info ..}\blink\bmenu{Team Code}.  The reference waypoint is set 
