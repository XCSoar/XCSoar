...
\section{Terrain and Topography}
...
\bmenu{Display}\blink\bmenu{Display}\blink\bmenu{Topo. On}
\end{quote}
...
\begin{quote}
\bmenu{Display}\blink\bmenu{Display}\blink\bmenu{Labels None}
\end{quote}
...
menu:
\begin{quote}
\bmenu{Display}\blink\bmenu{Display}\blink\bmenu{Trail}
\end{quote}
