...
Identifique a versão apropriada do XCSoar para seu hardware e sistema operacional \textsf{(Android, iOS, Windows, Linux, macOS)}
em \xcsoarwebsite{}.
...
Usando o padrão da instalação para Android, iOS, Windows, Linux e macOS irá fazer o trabalho suavemente.  Para deixar as coisas fáceis, permaneça com o padrão.  A instalação no cartão SD é possível.
