...
\begin{flushleft}\hspace*{1cm}\Mostrar{1}{Pan}{On}\\\end{flushleft}
...
\item Tecle \bmenuw{Flight download}
...
\item escolha outra ou tecle  \bmenuw{No} para finalizar
