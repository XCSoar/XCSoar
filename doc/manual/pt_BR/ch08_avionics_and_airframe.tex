...
Para outras plataformas incorporadas, a infobox \bmenuw{Bateria} está disponível e mostra o tempo restante de bateria, bem como o estado de carga (carregando AC ou AC-OFF quando se opera com a bateria interna).  
