...
\item[Dispositivo Bluetooth]  muitos dispositivos suportam conexões wireless como controle de jogos bluetooth que tem vários botões.  É mais adequado para interface do usuário do que monitoramento na fuselagem.
\end{description}
