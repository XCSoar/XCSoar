...
Em dispositivos com tela de toque, o usuário pode manualmente navegar através dos waypoint selecionando a infobox do waypoint e apertando as setas para cima e para baixo.
...
\bmenug{Alternativos}}.  Até dez opções de pouso são mantidas.  São filtradas pelos critérios de configuração (simples, prova ou casa). \config{alternatesmode} 
...
As InfoBoxes \textbf{Alternativo 1} / \textbf{Alternativo 2} e suas variantes
