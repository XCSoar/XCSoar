...
No início do sistema, após encontrado sinal de GPS, se um dispositivo barométrico está conectado (ex. Vega, AltairPro, FLARM, ou o barômetro interno no Android e iOS), o valor de QNH é ajustado automaticamente.  Este ajuste corrige QNH, bem como todas as altitudes barométricas e a altitude do terreno (solo).
