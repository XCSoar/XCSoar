...
Este documento é um manual do XCSoar para o piloto, um computador de vôo de código aberto que foi originalmente desenvolvido para dispositivos portáteis.  É assumido que o público-alvo deste manual deve ter um conhecimento das teorias fundamentais de vôo livre, e um conhecimento básico sobre o vôo de distância (Cross Country).
...
XCSoar roda em Android 1.6 ou superior.  Muitos telefones e tablets têm GPS interno, um sensor de pressão barométrica e um acelerômetro (carga G) que o XCSoar pode usar.
\item[iOS]
XCSoar roda em iPhone e iPad. Instale-o na Apple App Store.
Muitos destes dispositivos têm um sensor de pressão barométrica que o XCSoar pode usar quando presente.
\item [Leitores eBook]
...
\item[macOS]
XCSoar roda em computadores Apple Mac. Instale-o na Apple App Store
ou no site do XCSoar.
\item[Unix/Linux PC]
...
Uma boa maneira de aprender como usar o XCSoar é conectar o dispositivo a um computador que esteja rodando um simulador de vôo que possa fornecer dados NMEA a uma porta serial.  Alguns simuladores que funcionam dessa forma são Condor e X-Plane. 
