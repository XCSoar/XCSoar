...
Arquivos de terreno e topografia são acessados continuamente pelo XCSoar, portanto deverão estar localizados em armazenamento suficientemente rápido.  O acesso aos modernos cartões de memória geralmente tem o desempenho necessário para rodar adequadamente.

Todos os arquivos de dados deverão ser copiados para o diretório
\verb|XCSoarData|.  Veja o Capítulo~\ref{cha:installation} para o local deste diretório em cada plataforma.
...
\item A velocidade máxima de cruzeiro em m/s, usada como limite superior
  da velocidade MacCready (incluindo planeio final), para o computador não
  comandar velocidades de cruzeiro irrealistas.
\end{itemize}
