...
Para mostrar quais dados deverão ser carregados, clique no mapa (a maior parte da tela, com o glider branco no centro), escolha o menu \bmenug{Config 2}, e então clique 
\bmenug{Sistema}.  A tela de configuração deverá mostrar:
