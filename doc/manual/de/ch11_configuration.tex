...
\item[Steigflug Ausrichtung] Die Beschreibung der einzelnen Möglichkeiten ist identisch wie bei Vorflug-Ausrichtung.
...
\item[Auto Zoom]  Automatische herein- und Rauszommen, wenn an einen Wendepunkt herangeflogen wird, um die Kartendarstellung übersichtlich zu halten.\\
...
\item[Ab V6.6: Eigenständiger Seitenzoom] Individueller Maßstab für jede InfoboxSeite:\\
...
\item[Wind-Pfeil$^{\textcolor{blue}{\star}}$]  Auswahlmöglichkeiten zur Darstellung des Windpfeiles.\\
...
\item[FAI--Dreiecke Gebiete$^{\textcolor{blue}{\star}}$]  Zeigt Gebiete erforderlich für FAI-Dreiecke  \\
...
\item[Topographie Anzeige]  Zeigt topographische Eigenschaften der Karte wie Seen, Flüsse, Straßen, Städte etc.\
...
\item[Wolkenuntergrenze$^{\textcolor{blue}{\star}}$]  \label{conf:routeceiling}{\bf Ein / Aus}:  Wenn aktiviert wird bei der Routenplanung  das Steigen durch die Wolkenbasis begrenzt. Sie wird mit 500 m über der momentanen Flugzeughöhe und der Thermikhöhe angenommen.
  Wenn nicht aktiviert wird mit unbegrenztem Steigen geplant.
\sketch{figures/config-route.png}\item[Reichweiten Modus]  \label{conf:turningreach} Die Reichweitenberechnung kann Umwege durch vorhandene Hindernisse berücksichtiegn.
...
\todonum{welche Polare - die im Flug ermittelte, oder die eingegebene/vorhandene?}
...
\begin{description}
\item[FLARM Radar]  \label{conf:flarmdisplay} {\bf Ein / Aus}: \\
...
\item[Zentrierhilfe] \label{conf:thermalassistant} {\bf Ein / Aus}: \\
{\bf Ein}: Aktiviert die Anzeige des Thermikassistenten (Zentrierhilfe).\\
{\bf Aus}: Keine Zentrierhilfe.
\item[Thermikprofil] \label{conf:thermalband} {\bf Ein / Aus}: \\ 
...
\sketch{figures/config-audiovario.png}\item[Null-Ton$^{\textcolor{blue}{\star}}$]  Frequenz des Tones bei Nullschieber.
...
\sketch{figures/config-rules.png}\item[Abflughöhe bezogen auf$^{\textcolor{blue}{\star}}$]  Bezugshöhe der max. Abflughöhen:\\
...
\begin{center}
\includegraphics[angle=0,width=0.65\linewidth,keepaspectratio='true']{figures/config-infoboxset.png}
\end{center}
...
\achtung Flarm muß  mindestens mit 9600 oder 19200 eingestellt werden, um auch den Luftverkehr darstellen zu können! Eine Einstellung des \fl auf 4800 bietet ausschließlich die GPS-Daten!
