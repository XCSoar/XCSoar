...
Ausschließlich bei Geräten mit TouchScreen kann der Benutzer die Wegpunkte auch durch Antippen des Wegpunkt-{\InfoBox} und anschließendem Tippen auf hoch oder runter hindurchbewegen.
...
\config{alternatesmode} Die Alternativ-Wegpunkliste ist nun mit bis zu zehn erreichbaren Flugplätzen gefüllt, sortiert gemäß den Angaben des  "Alternativen-Modus" in den Konfigurations -Einstellungen
...
Die InfoBoxen \textbf{Alternative 1} / \textbf{Alternative 2} und deren
Varianten können entweder im Modus \textbf{AUTO} oder \textbf{MANUELL}
