...
REM: (Frage: ist der folgende Punkt noch aktuell?  REM: Sonst streichen/löschen!)

REM: \subsection*{Flugplatz Informationen}
REM: Diese Seite kann -sofern Daten zum Flugplatz REM: vorhanden- etliche Hinweise und Details zu 
REM: Flugplätzen enthalten. \sketchREM: {figures/dialog-REM waypointdetails1.png}
REM: Insbesondere sind hier enthalten Details zur REM: Landebahn, Landebahnrichtung, Höhe, Frequenz REM: usw.

\subsection*{Anzeige von Bildern etc.}
Sofern vorhanden, können auf den weiteren Seiten Bilder angezeigt werden, z.B. eine Grafik mit Anflugbeschreibung, Foto einer Landewiese usw. Näheres hierzu siehe auch Kap.~\ref{sec:airfield-details} 

Das Bild kann mit den Buttons + und - oben auf der Seite gezoomt werden, allerdings nur in zentraler Richtung.

Es gibt noch eine weitere Möglichkeit unterschiedlichste Mediendateien (beispielsweise .pdf, .jpg, .bmp, tif, mp4, etc.) mit einem default viewer/Programm anzuzeigen, das dann auch meist beliebig zoombar/ schwenkbar ist. Näheres hierzu ebenfalls im Kap.~\ref{sec:airfield-details} 
