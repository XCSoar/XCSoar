...
% -----Frage: ist der folgende Punkt noch aktuell?  
% Sonst streichen/löschen!--------------
%
...
Auf den weiteren Seiten können zusätzlich eigene Bilder angezeigt werden, z.B. eine Grafik mit Anflugbeschreibung, Foto einer Landewiese usw. Näheres hierzu siehe auch Kap.~\ref{sec:airfield-details} 
Das Bild kann dabei mit den Buttons + und - oben auf der Seite gezoomt werden, allerdings nur in zentraler Richtung.

Falls eingerichtet können mit einem Default-Viewer bzw. Programm des Geräts auch Bilder frei zoombar und unterschiedlichste Mediendateien (beispielsweise mehrseitige .pdf oder .jpg, .bmp, tif, mp4 Dateien u.v.m.) angezeigt werden. Details dazu sind ebenfalls im Kap.~\ref{sec:airfield-details} beschrieben.
