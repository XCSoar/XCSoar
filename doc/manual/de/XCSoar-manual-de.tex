...
\usepackage{color}
\usepackage{times}
\usepackage{multicol}%komfortable Spalten in Tabellen 
\usepackage{multirow}%komfortable Zeilen in Tabellen 
\usepackage{booktabs}
