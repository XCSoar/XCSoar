...
Unter Android verwendet \xc den Beschleunigungssensor des Telefons, wenn kein externer G-Sensor angeschlossen ist.
...
Zur Verbesserung der Windberechnung werden, falls vorhanden, auch Fahrtmesser- und Drehraten-Messwerte herangezogen.
...
Bei Geräten mit Touch-Screen kann auch mittels der Wind-InfoBox der Wind in
...
Falls Werte aus der TAS-Messung zur Verfügung stehen, also ein entsprechendes Instrument angeschlossen ist,
werden Geschwindigkeitsschwankungen beim Kreisen kompensiert.
Falls ein Gyroskop (IMU Sensor) angeschlossen ist, können Änderungen der Querneigung,
sowie Änderungen der Drehgeschwindigkeit erkannt und die betreffenden Kreise von der Windberechnung ausgeschlossen werden. \index{Wind!Ermittlung}
