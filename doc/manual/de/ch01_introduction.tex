...
In der Zwischenzeit läuft \textsf{XCSoar} auf fast allen Plattformen und ist derzeit auf Android mit der derzeit 
...
\item[iOS]
\textsf{XCSoar} läuft auf iPhone und iPad. Installation über den Apple App Store.
Viele dieser Geräte haben einen barometrischen Drucksensor, den \textsf{XCSoar} nutzen kann.
\item[macOS]
\textsf{XCSoar} läuft auf Apple-Mac-Rechnern. Installation über den Apple App Store
oder die XCSoar-Homepage.
\item[Unix/Linux PC]
...
Viele Telefone und Tablets haben GPS, einen barometrischen Drucksensor und einen Beschleunigungssensor (G-Last), den \textsf{XCSoar} nutzen kann. 
