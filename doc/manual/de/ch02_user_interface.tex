...
Für ein typisches 320$\times$240 Pixel-Display im "Hochkant"-Modus stehen jeweils vier {\InfoBox}en am oberen und unteren Rand des Displays zur Verfügung. 
...
\begin{itemize}
 \item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_up.pdf}}] \p{Hoch}: Zoom herein 
 \item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_down.pdf}}] \p{Runter}: Zoom heraus 
 \item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_left.pdf}}] \p{Links}: Nächste InfoboxSeite 
 \item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_right.pdf}}] \p{Rechts}: vorherige InfoboxSeite 
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_du.pdf}}] \p{Runter-Hoch}: Menü anzeigen 
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_dr.pdf}}] \p{Runter-Rechts}: Wegpunkt Dialog anzeigen 
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_rd.pdf}}] \p{Rechts-Runter}: Aufgabenverwaltung
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_urdl.pdf}}] \p{Hoch-Rechts-Runter-links}:  Verschiebemodus.  Dies geht aber auch  auch mit auf Android üblichem Spreizen oder Zusammenfahren von Zeigefinger und Daumen!
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_uldr.pdf}}] \p{Hoch-Links-Runter-Rechts}: Schnellmenü
\end{itemize}
...
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_up.pdf}}] \p{Hoch}: Zoom herein 
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_down.pdf}}] \p{Runter}: Zoom heraus 
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_left.pdf}}] \p{Links}: Letztes Ziel (Flugzeug)
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_right.pdf}}] \p{Rechts}: Nächstes Ziel (Flugzeug)
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_ud.pdf}}]  \p{Hoch-Runter}: Aktiviere AutoZoom
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_dr.pdf}}] \p{Runter-Rechts}:  Öffne Detail-Fenster des gewählten Zieles (Flugzeuges)
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_rd.pdf}}] \p{Rechts-Runter}:  Öffnet die Aufgabenverwaltung
\item[\raisebox{-1em}{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_rl.pdf}}] \p{Rechts-Links}: Wechselt zur Anzeige von Werten wie z.B.\ Steigen, relativer Höhe etc.\ des angewählten Zieles (Flugzeuges) )
\end{itemize} 