\input{XCBlitzIIKonf.tex}%Konfiguration und Buttondefinitionen
%\DeclareUnicodeCharacter{00B0}{$^{\circ}$}
%\DeclareUnicodeCharacter{00B9}{$^1$}
%\DeclareUnicodeCharacter{00B2}{$^2$}
%\DeclareUnicodeCharacter{00B3}{$^3$}
%\DeclareUnicodeCharacter{00B5}{${\mu}$}%
%{\color{red}\ovalbox{\textcolor{black}{}}}
...
\newpage
\fancyhead[R]{\includegraphics[angle=0,width=0.15\linewidth,keepaspectratio='true']{figures/xcsoar-title.png}}
\pagestyle{fancy}
%%%%%--------------------------------------------------------------------%%%%%
%%%%%--------------------------------------------------------------------%%%%%
%%%%%--------------------------------------------------------------------%%%%%
...
%%%%%--------------------------------------------------------------------%%%%%
Nach dem Herunterladen der entsprechenden Programmversion {\textsf (Android, PC, Windows Mobile, PPC2000, PPC2003, Linux, Mac)}
...
\printindex
\end{document}
%\maketitle%\title{Blitz}
%\nav{3}{Wegpunkt}{Details}
%\ansi{2}{Hupatz}{guggsud}
%\konf{3}{Hurz}{Herjeh}
%\info{1}{nanu}{nana}
%\sk
