...
\marginpar{\includegraphics[angle=0,width=\linewidth,keepaspectratio='true']{figures/dialog-basicsettings.png}}
...
\section{Sollfahrt  mit Risikofaktor}\label{sec:safty-factors}
...
\multicolumn{2}{l}{Die Skalierung dieser Pfeile der Endanflugsanzeige beträgt $+/-$ 500 m,} \\
\multicolumn{2}{l}{darüberhinaus wird die Pfeilspitze abgehoben.}
\end{tabular}
\end{center}
...
\marginpar{\includegraphics[angle=0,width=1.0cm,keepaspectratio='true']{figures/fig-finalglide-halfabove.png}}
...
\begin{maxipage}
\begin{center}
\includegraphics[angle=0,width=0.8\linewidth,keepaspectratio='true']{figures/figure_auto_maccready-de.pdf}
\end{center}
\end{maxipage}
...
Klappenstellung und anderen Optimierungsversuchen wie z-.B. Ruderspalteabdichtungen etc.
