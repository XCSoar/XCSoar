...
%%%%%--------------------------------------------------------------------%%%%%
Nach dem Herunterladen der entsprechenden Programmversion {\textsf (Android, iOS, Windows, Linux, macOS)}
...
Die Installationsroutinen von Android, iOS, Windows, Linux und macOS machen dies von alleine. Der
...
\item[4.] Luftraumfile laden:
 ...
 {\large\url{https://www.daec.de/fachbereiche/luftraum-flugbetrieb/luftraumdaten}}
