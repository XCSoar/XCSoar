...
Gelände- und Topographiedateien werden von \xc ständig gelesen und
sollten daher auf einem ausreichend schnellen Datenträger liegen.
Moderne Speicherkarten erfüllen diese Anforderung in der Regel.
...
Siehe Kapitel~\ref{cha:installation} zum Speicherort dieses Verzeichnisses auf den jeweiligen Plattformen.
...
anderer Kartenausschnitt o.ä.), kann unter \url{https://mapgen.xcsoar.org/}  der \xc-Karten-Generator
...
\item Die max.\  Reisegeschwindigkeit in $m/s$ als Obergrenze für die
 MacCready-Sollfahrt (einschließlich Endanflug), damit der Rechner keine
 unrealistisch hohen Reisegeschwindigkeiten vorgibt
\end{itemize}
