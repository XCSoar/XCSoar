...
\jindent{\bmenut{Advance}{(Auto)}}{ Todo \ldots Arms the automatic task
waypoint trigger. }
%	Todo add to dynamic buttons \jindent{\bmenut{Abort}{Start}}{ Abort the last
%Start } 
...
\jindent{\bmenut{MC}{Auto}}{ Toggles automatic/manual MacCready (TODO when in
final glide.?). }
\jindent{\bmenut{Flight}{Setup}}{ Displays the basic settings (bugs/ballast/QNH)
dialog. }
...
\jindent{\bmenus{Accel}}{ Todo, what is that for? }
...
ToDo: that list of dialog explanations should move else where
...
\end{center}
\end{description}
ToDo: end of that list of dialog explanations should move else where
