...
\begin{center}
\includegraphics[angle=0,width=\linewidth,keepaspectratio='true']{figures/config-symbols.png}
\end{center}
...
\todonum[inline]{ scheme ``grey'' is missing }
...
%period of inactivity when operating on internal battery power (for PDA only).
...
\begin{center}
\includegraphics[angle=0,width=\linewidth,keepaspectratio='true']{figures/config-othergauges.png}
\end{center}
