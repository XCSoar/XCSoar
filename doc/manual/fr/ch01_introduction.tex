...
Ce document est le manuel d'utilisation d'\xc, logiciel de navigation aérienne, à source ouverte, développé à l'origine pour les appareils de poche. Le lecteur est censé avoir de bonnes connaissances des fondamentaux de la théorie du vol à voile et un minimum de pratique du vol sur la campagne.
