...
Les fichiers de relief et de topographie sont accédés en permanence quand le logiciel fonctionne. Ils faut donc les placer sur les mémoires les plus rapides. Les vitesses d'accès des dernières cartes mémoire permettent de ne plus poser de problème de performance. 

Les fichiers de données doivent être copiés dans le répertoire
\verb|XCSoarData|. Voir le chapitre~\ref{cha:installation} pour
l'emplacement de ce répertoire sur chaque plateforme.
...
\item Vitesse maximum de croisière en m/s, utilisée comme limite supérieure
  de la vitesse MacCready (y compris en arrivée), pour éviter que le
  calculateur ne commande des vitesses de croisière irréalistes.
\end{itemize}
