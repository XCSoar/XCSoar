...
Pour un affichage de 320x240 en mode portrait, il y a quatre InfoBoxes au-dessus et quatre
...
\begin{itemize}
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_du.pdf}}] BH~: Affiche le menu principal
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_up.pdf}}] H: Zoome
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_down.pdf}}] B: Dézoome
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_left.pdf}}] G: Incrémente la page d'écran (Normal, Aux., Plein écran...) 
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_right.pdf}}] D: Décrémente la page d'écran (Normal, Plein écran...) 
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_urdl.pdf}}] HDBG, comme un~P~: Mode \textbf{P}anorama. Peut aussi être activé en écartant deux doigts sur l'écran
\end{itemize}
\vspace{2em}
...
\begin{itemize}
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_dr.pdf}}] BD, comme un~L~: Affiche la fenêtre de dialogue de sélection du point de virage, similaire à l'élément du menu ``\textbf{L}iste de points de virage''.
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_rd.pdf}}] DB, comme un~T~: Ouvre le gestionnaire de circuit (``\textbf{T}ask en anglais)
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_dl.pdf}}] BG~: Affiche la liste des dégagements
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_ud.pdf}}] HB~: Active le zoom automatique
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_uldr.pdf}}] HGBD~: Ouvre le menu rapide
\end{itemize}
\vspace{2em}
...
\begin{itemize}
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_urd.pdf}}] HDB, comme un~A~: Affiche le fenêtre d'\textbf{A}nalyses.
\item[\raisebox{-1em}
{\includegraphics[angle=0,width=0.1\linewidth,keepaspectratio='true']{figures/gesture_ldrdl.pdf}}] GBDBG, comme un ~S~: Affiche le fenêtre d'états (``\textbf{S}tatus'' en anglais).
\end{itemize}
