...
système d'exploitation \textsf{(Android, iOS, Windows, Linux, macOS)} 
...
En utilisant les valeurs par défaut des installateurs pour Android, iOS, Windows, Linux et macOS, cela devrait
