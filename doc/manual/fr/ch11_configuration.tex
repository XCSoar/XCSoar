...
Pour l'instant il y a deux protocoles de tracking disponibles. {\it 'Sky-Lines'} comme projet interne à XCSoar : pour plus de détails sur ce service aller regarder le site {\href{https://skylines.aero}{skylines.xcsoar.org}}.\\
...
\item[Key] Vous devez créer votre propre clé (key)  sur le site web {\href{https://skylines.aero/tracking/info}{skylines.xcsoar.org/tracking/info}} et la saisir dans ce champ afin d'être identifié par le service de tracking.
