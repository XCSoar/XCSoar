...
\begin{quote}
\bmenug{Info. 2}\blink\bmenug{Aux Info On}
\end{quote}
...
\item Depuis le menu
\begin{quote}
\bmenug{Config.}\blink\bmenug{MacCready $+$/$-$}
\end{quote}
...
\begin{quote}
\bmenug{Config.}\blink\bmenug{Options Vol}
\end{quote}
...
\begin{quote}
\bmenug{Config.}\blink\bmenug{MacCready Auto}
\end{quote}
