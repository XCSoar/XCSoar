...
Au démarrage, une fois que le GPS a acquis une position, et si un appareil délivrant la pression atmosphérique est connecté (ex~: Vega, AltairPro, FLARM, ou le baromètre intégré sous Android et iOS), la mise à jour du QNH est automatique.
