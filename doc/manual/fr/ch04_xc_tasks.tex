...
(Android, iOS, Windows, Linux, macOS\textellipsis).
...
\bmenug{Dégagements}} Jusqu'à dix options d'atterrissage
...
Les InfoBoxes \textbf{Dégagement 1} / \textbf{Dégagement 2} et leurs variantes
peuvent fonctionner en mode \textbf{AUTO} ou en mode \textbf{MANUEL}. AUTO est
